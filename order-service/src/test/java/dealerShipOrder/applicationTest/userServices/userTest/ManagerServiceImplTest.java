...
import dealerShipOrder.application.services.userService.manager.ManagerServiceImpl;
...
class ManagerServiceImplTest {
    ...
    @BeforeEach
    void setUp() {
        manager = new Manager("John", "Doe", null, "john@email.com", "+1234567890", "password123", "test-user-id");
    ...
    void shouldGetManagerByIdSuccessfully() {
        ...
        ManagerResponse result = managerService.getUserById("test-user-id");
    ...
    void shouldThrowExceptionWhenUserIsNotManager() {
        ...
        when(userRepository.findById("test-user-id")).thenReturn(Optional.of(nonManager));

        assertThrows(DomainValidationException.class, () -> {
            managerService.getUserById("test-user-id");
        });
    }
    ...
    void shouldChangePasswordSuccessfully() {
        ...
        when(userRepository.findById("test-user-id")).thenReturn(Optional.of(managerSpy));
