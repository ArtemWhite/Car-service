...
import dealerShipOrder.application.dtos.request.userRequest.UserFilterRequest;
...
class SystemAdminServiceImplTest {
    ...
    @BeforeEach
    void setUp() {
        admin = new SystemAdmin("Admin", "User", null, "admin@email.com", "+123", "pass", "test-user-id", AdminLevel.SUPER_ADMIN);
    ...
    void shouldGetSystemAdminByIdSuccessfully() {
        ...
        SystemAdminResponse result = systemAdminService.getUserById("test-user-id");
    ...
    void shouldChangeOwnPasswordSuccessfully() {
        ...
        passwordRequest.setUserId("test-user-id");
    ...
    void shouldCreateManagerSuccessfully() {
        ...
        createRequest.setEmployeeId("test-user-id");
    ...
    void shouldGetUserDetails() {
        ...
        UserBaseResponse result = systemAdminService.getUserDetails("user123");
