...
import dealerShipOrder.application.services.orderService.OrderServiceImpl;
...
class OrderServiceImplTest {
    ...
    void shouldFilterOrdersByStatus() {
        ...
        Order paidOrder = Order.createInStockOrder("order1", "test-user-id", "car123");
    ...
    void shouldFilterOrdersByType() {
        ...
        Order customOrder = Order.createCustomOrder("order1", "test-user-id", "config123", "model123");
    ...
    void shouldFilterOrdersByDateRange() {
        ...
        Order newOrder = Order.createInStockOrder("order1", "test-user-id", "car123");
    ...
    void shouldCombineMultipleFilters() {
        ...
        Order matchingOrder = Order.createInStockOrder("order1", "test-user-id", "car123");
    ...
    void shouldReturnEmptyListWhenNoOrdersMatchFilters() {
        ...
        Order activeOrder = Order.createInStockOrder("order1", "test-user-id", "car123");
