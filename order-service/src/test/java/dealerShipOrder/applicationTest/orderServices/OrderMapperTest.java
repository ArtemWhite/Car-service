...
class OrderMapperTest {
    ...
    void setUp() {
        ...
        inStockOrder = Order.createInStockOrder("order123", "test-user-id", "car123");
        customOrder = Order.createCustomOrder("order456", "client456", "config456", "model456");

        inStockOrder.assignManager("test-user-id");
    }
    ...
    void shouldUpdateOrderStatusToAwaitingPayment() {
        Order order = Order.createInStockOrder("order1", "test-user-id", "car123");
        order.assignManager("test-user-id");
    ...
    void shouldUpdateOrderStatusToStockConfirmed() {
        Order order = Order.createCustomOrder("order1", "test-user-id", "config123", "model123");
    ...
    void shouldConvertOrderWithManagerToOrderResponse() {
        ...
        assertNotNull(result);
        assertEquals("test-user-id", result.getManagerId());
    }
