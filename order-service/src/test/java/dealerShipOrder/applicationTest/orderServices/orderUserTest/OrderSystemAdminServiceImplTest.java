...
import dealerShipOrder.application.services.orderService.systemAdmin.OrderSystemAdminServiceImpl;
...
class OrderSystemAdminServiceImplTest {
    ...
    void shouldUpdateOrderStatusSuccessfully() {
        Order realOrder = Order.createInStockOrder("order123", "test-user-id", "car123");
        realOrder.assignManager("test-user-id");
    ...
    void shouldDeleteInactiveOrderSuccessfully() {
        Order cancelledOrder = Order.createInStockOrder("order123", "test-user-id", "car123");
    ...
    void shouldThrowExceptionWhenAdminHasNoPermission() {
        ...
        when(userRepository.findById("test-user-id")).thenReturn(Optional.of(noPermissionAdmin));
