...
public class XUserHeaderFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response,
        ...
        System.out.println("=== XUserHeaderFilter: X-User-Id = " + userId + " for " + request.getRequestURI());
        ...
        if (userId != null && !userId.isBlank()) {
            try {
                ...
                System.out.println("=== XUserHeaderFilter: userId = " + userId + ", role from DB = " + role);
                ...
                if (role != null) {
                    ...
                    System.out.println("=== XUserHeaderFilter: Set auth with roles: " + authorities);
                }
            } catch (Exception e) {
                System.err.println("=== XUserHeaderFilter ERROR: " + e.getMessage());
                e.printStackTrace();
            }
        }
