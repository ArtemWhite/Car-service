...
import application.services.testDriveService.manager.TestDriveManagerServiceImpl;
...
class TestDriveManagerServiceImplTest {
    ...
    void shouldAssignManagerToRequestSuccessfully() {
        ...
        assertEquals("manager123", testDriveRequest.getManagerId());
    ...
    void shouldGetManagerRequestsSuccessfully() {
        ...
        when(userRepository.findById("manager123")).thenReturn(Optional.of(manager));
        when(testDriveRepository.findByManagerId("manager123")).thenReturn(List.of(testDriveRequest));
        when(carRepository.findById("car123")).thenReturn(Optional.of(mockCar));
        ...
        verify(testDriveRepository, times(1)).findByManagerId("manager123");
    }
    ...
    void shouldReturnEmptyListWhenManagerHasNoRequests() {
        when(userRepository.findById("manager123")).thenReturn(Optional.of(manager));
        when(testDriveRepository.findByManagerId("manager123")).thenReturn(List.of());
    ...
    void shouldCompleteRequestSuccessfully() throws Exception {
        ...
        managerIdField.set(pastRequest, "manager123");
