...
import application.dtos.response.userResponse.users.WarehouseAdminResponse;
import application.mapper.UserMapper;
import application.services.userService.warehouseAdmin.WarehouseAdminServiceImpl;
...
class WarehouseAdminServiceImplTest {
    ...
    @BeforeEach
    void setUp() {
        warehouseAdmin = new WarehouseAdmin("Bob", "Johnson", null, "bob@email.com", "+1111111111",  "admin123", "password123");
        ...
        changePasswordRequest.setUserId("admin123");
    ...
    void shouldGetWarehouseAdminByIdSuccessfully() {
        ...
        WarehouseAdminResponse result = warehouseAdminService.getUserById("admin123");
    ...
    void shouldThrowExceptionWhenUserIsNotWarehouseAdmin() {
        ...
        when(userRepository.findById("user123")).thenReturn(Optional.of(nonAdmin));

        assertThrows(DomainValidationException.class, () -> {
            warehouseAdminService.getUserById("user123");
        });
    }
    ...
    void shouldThrowExceptionWhenUserIdMismatch() {
        changePasswordRequest.setUserId("otherAdmin");
